...
#define  SHELL_VERSION                                 10200u   /* See Note #1.                                         */
...
typedef  struct  shell_module_cmd {
    CPU_CHAR    Name[SHELL_CFG_MODULE_CMD_NAME_LEN_MAX];        /* Name (prefix) of module cmd (see Note #1).           */
    void       *PrevModuleCmdPtr;                               /* Ptr to PREV      module cmd.                         */
    void       *NextModuleCmdPtr;                               /* Ptr to NEXT      module cmd.                         */
