...
#define  FS_DEV_NOR_PHY_MAX_PAGE_PGM_ms                   5u    /* See Note #1                                          */
#define  FS_DEV_NOR_PHY_MAX_SECTOR_ERASE_ms            	400u
#define  FS_DEV_NOR_PHY_MAX_32K_BLK_ERASE_ms           1600u
#define  FS_DEV_NOR_PHY_MAX_64K_BLK_ERASE_ms           2000u
#define  FS_DEV_NOR_PHY_MAX_CHIP_ERASE_ms            200000u

#define  FS_DEV_NOR_W25Q_DUMMY_BYTE                    0xA5u    /* See Note #2                                          */

#define  FS_DEV_NOR_PHY_BLK_SIZE             			4096u
...
#define  FS_DEV_NOR_PHY_CMD_SECTOR_ERASE				0x20u   /* Sector Block Erase.                                  */
...
static  const  FS_DEV_NOR_PHY_DESC  FSDev_NOR_PHY_DevTbl[] = {
    {0x4018u,     256, FS_DEV_NOR_PHY_BLK_SIZE_64K},            /* W25Q128*/
};
...
* Return(s)   : none.
*
* Note(s)     : (1) When using operational code FS_DEV_NOR_PHY_CMD_FAST_READ (0x0Ch), eight "dummy" clocks
*                   must be added after the Four Address bytes. The dummy clocks allow the device's
                                ...
                                FS_ERR               *p_err)
{
    ...
    //cmd[4u] = (CPU_INT08U)((start >> (0u * DEF_OCTET_NBR_BITS)) & DEF_OCTET_MASK);
                                      ...
                                      FS_ERR               *p_err)
{
    ...
    switch (size)
    {
    	case FS_DEV_NOR_PHY_BLK_SIZE_32K:                       /* 64KBytes Block erase.                               */
                cmd_erase = FS_DEV_NOR_PHY_CMD_BLK_ERASE_32K;
                timeout   = FS_DEV_NOR_PHY_MAX_32K_BLK_ERASE_ms;
                break;
    ...
    //cmd[4] = (CPU_INT08U)((start >> (0u * DEF_OCTET_NBR_BITS)) & DEF_OCTET_MASK);
